...
$university = "brac";
	 ...
	 // header("refresh:0.0000000000000000000000000000000000000000000000000001;url=http://localhost/project/brac_admin.php?");
...
<head>
	<script>
		window.location.replace("http://localhost/project/brac_faculty_send_report.php");
	</script>
