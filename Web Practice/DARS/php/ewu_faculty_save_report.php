...
$university = "ewu";
	 ...
	 // header("refresh:0.0000000000000000000000000000000000000000000000000001;url=http://localhost/project/ewu_admin.php?");
...
<head>
	<script>
		window.location.replace("http://localhost/project/ewu_faculty_send_report.php");
	</script>
