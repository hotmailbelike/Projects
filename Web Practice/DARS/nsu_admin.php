	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-sm-12 bd">
				...
				<form action="./php/nsu_admin_processor.php" method="get" class="form-horizontal" >
			...
			<div class="col-md-6 col-sm-12 bd3">
				...
				<form action="./php/nsu_admin(edit)_processor.php" method="get" class="form-horizontal">
				  <div class="form-group">
			...
			<div class="col-md-12 col-sm-12 bd2">
				...
				<form action="./php/nsu_admin(delete_by_id)_processor.php" method="get" class="form-horizontal">
				  <div class="form-group">
				    <label for="id" class="col-sm-2 control-label">ID</label>
				    <div class="col-sm-10">
